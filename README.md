...
[![GitHub Stars](https://img.shields.io/github/stars/yashsarvaiya1?label=Total%20Stars&style=flat-square&color=yellow)](https://github.com/yashsarvaiya1?tab=repositories)  
...
- 👥 **Role**: Leading full-stack teams  
- 🏗️ **Focus**: Financial Apps, ERP Systems, AI Platforms  
- 🤖 **AI Expertise**: LangGraph + Google Vertex AI  
- ⚙️ **DevOps**: Docker, Kubernetes, GitHub Actions  
- 🚀 **Deployment**: VM, Containers, Kubernetes, Cloud  
- 📱 **Mobile**: Expo + Flutter cross-platform apps  
- 📧 **Email**: [iamyashsarvaiya@gmail.com](mailto:iamyashsarvaiya@gmail.com)  
...
<img src="https://user-images.githubusercontent.com/74038190/212750147-854a394f-fee9-4080-9770-78a4b7ece53f.gif" width="400" alt="analytics-gif">
...
🚀 **Projects Led:** 15+ → 🎯🎯🎯🎯🎯  
⚡ **Deployments:** 50+ → 🚀🚀🚀🚀🚀  
🛠️ **Tech Stacks:** 5 Major → ⚙️⚙️⚙️⚙️⚙️  
...
| ----------------- | ------------------------ | ---------------------- |
| 🎨 **Frontend**   | Next.js + Zustand        | State & UI             |
| ⚡ **API**        | FastAPI + Pydantic       | Validation & endpoints |
| 🗄️ **Database**  | PostgreSQL               | Persistence            |
